...
const pageEntries = [
  {
    ...
    eyebrow: "Portfolio",
    title: hero.headline,
    summary: hero.supportingText,
    image: hero.image || site.avatar,
    metaLabel: site.title,
    tagLabel: "Home",
  },
  {
    output: "about.png",
    eyebrow: "About",
    title: `${site.name} | ${about.headline}`,
  ...
  },
  {
    output: "blog.png",
    eyebrow: "Writing",
    title: "Technical writing, systems thinking, and product-minded engineering.",
    summary: "Posts spanning architecture notes, project narratives, and technical storytelling.",
    image: hero.image || site.avatar,
    metaLabel: site.title,
    tagLabel: "Blog",
  },
  {
    output: "projects.png",
    eyebrow: "Projects",
    title: "Selected software work, platform thinking, and implementation detail.",
    summary: "Project write-ups that show the why, the architecture, and the execution behind the work.",
    image: hero.image || site.avatar,
    metaLabel: site.title,
    tagLabel: "Projects",
  },
  {
    ...
    summary: "Endorsements that reflect technical execution, systems thinking, and collaboration quality.",
    image: site.avatar,
    metaLabel: site.title,

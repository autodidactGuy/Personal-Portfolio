...
var src_default = {
  async fetch(request, env) {
    ...
    if (url.pathname === "/callback") {
      ...
      const allowedUsers = String(env.ALLOWED_GITHUB_USERS || "").split(",").map((value) => value.trim().toLowerCase()).filter(Boolean);
...
// .wrangler/tmp/bundle-AcZ3L6/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-AcZ3L6/middleware-loader.entry.ts

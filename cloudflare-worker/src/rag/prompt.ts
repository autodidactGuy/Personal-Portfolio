		...
		messages: [
			...
			},
			{
				...
				content: [
					...
					"If the question is a short keyword-like prompt such as a technology, domain, industry, capability, or topic, assume the user is asking whether that concept appears in Hassan Raza's background or work unless the prompt is clearly unrelated.",
					"Questions about domains like fintech, payments, observability, distributed systems, AI, backend systems, infrastructure, startups, education, writing, projects, or recommendations are in-scope portfolio questions, not unrelated questions.",
